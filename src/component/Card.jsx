...
export default function Card({ cardData }) {
  return (
    <div className="card w-50 h-auto p-6 rounded-md bg-gray-100">
      <div className="flex flex-col items-start justify-start gap-2">
        {cardData?.contacts?.github ? (
          ...
          <span className="text-sm text-gray-400 font-normal select-none cursor-default">
            {"Please add your GitHub Profile Link"}
          </span>
        )}
